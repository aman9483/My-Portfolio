  ...
  const data = [
    {
      ...
      college: "Indian Institute of Business Management",
      skills: ["React.js", "Next.js", "React Native", "JavaScript"],
      class:
    ...
    },
    {
      ...
      college: "Park Mount Public School",
      skills: ["Physics", "Chemistry", "Mathematics", "Computer"],
      class:
