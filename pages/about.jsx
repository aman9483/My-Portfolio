  ...
  return (
    <div className="px-10 sm:px-20 md:px-32 lg:mb-12 lg:px-60 mx-auto max-w-[75rem]">
      ...
      <p className="mt-6 mb-12 leading-10 font-normal">
       A Full Stack Web and Mobile App Developer crafting modern, reactive, and
        user-friendly applications with the latest technologies.{" "}
      <span className="inline-flex items-baseline">
      <Image src={Rocket} alt="rocket" className="self-center w-8 h-8 mx-1" />
     </span>{" "}
      ...
      <span className="inline-flex items-baseline">
      <Image src={Sparkles} alt="rocket" className="self-center w-8 h-8 mx-1" />
     </span>{" "}
      Experienced in ReactJS, React Native, NextJS, and state management like
      Redux, with proficiency in web technologies such as HTML5, CSS3, and
      JavaScript ,NodejS,  ExpressJs , MongoDB. Skilled in building large-scale web applications, ensuring
      compatibility across various browsers and adhering to design constraints
       on the web. Also adept at creating responsive user interfaces.{" "}
    <span className="inline-flex items-baseline">
      <Image src={Flash} alt="rocket" className="self-center w-8 h-8 mx-1" />
    </span>{" "}
  </p>
